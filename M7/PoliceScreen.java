...
public class PoliceScreen {
    ...
    public PoliceScreen(Game g, Police p, int index) {
        ...
        forfeitButton.addActionListener(e -> {
            javax.swing.SwingUtilities.invokeLater(new Runnable() {
                public void run() {
                    NPCResultScreen n = new NPCResultScreen(p.forfeit(g), false, index, g);
                    frame.dispose();
                }
            });
        });
        ...
        fleeButton.addActionListener(e -> {
            javax.swing.SwingUtilities.invokeLater(new Runnable() {
                public void run() {
                    NPCResultScreen n = new NPCResultScreen(p.flee(g), true, index, g);
                    frame.dispose();
                }
            });
        });
        ...
        fightButton.addActionListener(e -> {
            javax.swing.SwingUtilities.invokeLater(new Runnable() {
                public void run() {
                    NPCResultScreen n = new NPCResultScreen(p.fight(g), false, index, g);
                    frame.dispose();
                }
            });
        });
