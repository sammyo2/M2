...
public class ConfirmationScreen {
    ...
    public ConfirmationScreen(String name, String difficulty, int pilotField,
        ...
        if (difficulty.equals("Easy")) {
            creditsLabel.setText("Credits: 20000");
        } else if (difficulty.equals("Medium")) {
            creditsLabel.setText("Credits: 15000");
        } else {
            creditsLabel.setText("Credits: 10000");
        }
        ...
        startButton.addActionListener(e ->
                javax.swing.SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        ...
                        ShipScreen sS = new ShipScreen(g);
                        g.setSS(sS);
                        UniverseMap uM = new UniverseMap(g);
                        g.setUM(uM);
