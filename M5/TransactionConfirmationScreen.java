...
public class TransactionConfirmationScreen {
    public TransactionConfirmationScreen(int itemIndex, int q, Game g, int index,
                                         String label, int price, ShipScreen sS) {
        ...
        exitButton.addActionListener(e -> {
            SwingUtilities.invokeLater(new Runnable() {
                public void run() {
                    TransactionScreen tS = new TransactionScreen(g, index, label, sS);
                    frame.dispose();
                }
            });
        });
            ...
            SwingUtilities.invokeLater(new Runnable() {
                public void run() {
                    if (label.startsWith("B")) {
                        ...
                        TransactionScreen tS = new TransactionScreen(g, index, label, newSS);
                        frame.dispose();
                    } else {
